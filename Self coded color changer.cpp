...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   // glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, image);
    ...
    //stbi_loadf_from_file('INSERT FILE DIRECTORY', width, height)
    /*
    FIND OUT ABOUT STB IMAGE
    */
    ...
    while(!glfwWindowShouldClose(mainWindow))
    {
        ...
        GLfloat redValue = (sin(timeValue) /2) + 1.0;
        GLfloat greenValue = (sin(timeValue+5) /2) + 1.0;
        GLfloat blueValue = (sin(timeValue+10) /2) + 1.0;
